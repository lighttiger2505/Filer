...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // ファイル一覧を表示するビューを作成して、Rootのフォルダとコンテキストを設定
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Filer" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Filer.sqlite"];
...
- (Folder*)getRootComposite
{
    ...
    // 継承元の親エンティティを指定することで子のエンティティも取得することができる
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"Composite" 
